...
const totalSeasons  = data.totalSeasons ?? 13;
const currentSeason = seasons.length;           // reverse-ordered: length == current season number
...
const pastHtml = seasons
  .slice(1)
  .map((item, i) => renderPastItem(item, currentSeason - 1 - i))
  .join('\n');
